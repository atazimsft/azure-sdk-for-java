...
@Fluent
public final class RecognizeAttributes {
    /*
     ...
     */
    public RecognizeAttributes setPausePlayOnResponse(Boolean pausePlayOnResponse) {
     ...
     * @return the RecognizeOptions object itself.
     */
    public RecognizeAttributes setInitialSilenceTimeoutInSeconds(Integer initialSilenceTimeoutInSeconds) {
     ...
     * @return the RecognizeOptions object itself.
     */
    public RecognizeAttributes setDtmfOptions(DtmfOptions dtmfOptions) {
