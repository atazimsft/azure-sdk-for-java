...
public final class MicrosoftTeamsUserIdentifier {
    ...
    private CommunicationCloudEnvironment cloud;
     ...
     */
    public MicrosoftTeamsUserIdentifier setUserId(String userId) {
        this.userId = userId;
        return this;
    }
     ...
     * @return the MicrosoftTeamsUserIdentifier object itself.
     */
    public MicrosoftTeamsUserIdentifier setIsAnonymous(Boolean isAnonymous) {
     ...
     */
    public CommunicationCloudEnvironment getCloud() {
        return this.cloud;
    }
     ...
     * @return the MicrosoftTeamsUserIdentifier object itself.
     */
    public MicrosoftTeamsUserIdentifier setCloud(CommunicationCloudEnvironment cloud) {
        this.cloud = cloud;
        return this;
    }
}
