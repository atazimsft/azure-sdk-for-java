...
public final class ServerCallingsImpl {
    ...
    public interface ServerCallingsService {
        ...
        Mono<Response<CallConnectionProperties>> createCall(
        ...
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<CallConnectionProperties>> answerCall(
                @HostParam("endpoint") String endpoint,
                @QueryParam("api-version") String apiVersion,
    ...
    public Mono<Response<CallConnectionProperties>> createCallWithResponseAsync(CreateCallRequestInternal body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<CallConnectionProperties>> createCallWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<CallConnectionProperties> createCallAsync(CreateCallRequestInternal body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<CallConnectionProperties> createCallAsync(CreateCallRequestInternal body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CallConnectionProperties createCall(CreateCallRequestInternal body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CallConnectionProperties> createCallWithResponse(CreateCallRequestInternal body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<CallConnectionProperties>> answerCallWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<CallConnectionProperties> answerCallAsync(AnswerCallRequestInternal answerCallRequest) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<CallConnectionProperties> answerCallAsync(
            AnswerCallRequestInternal answerCallRequest, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CallConnectionProperties answerCall(AnswerCallRequestInternal answerCallRequest) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CallConnectionProperties> answerCallWithResponse(
            AnswerCallRequestInternal answerCallRequest, Context context) {
